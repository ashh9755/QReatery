...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'QrScanner')
              : QrScannerWidget(
                  orderid: params.getParam(
                    'orderid',
                    ParamType.String,
        ...
        FFRoute(
          name: Qrscanner1Widget.routeName,
          path: Qrscanner1Widget.routePath,
          builder: (context, params) => Qrscanner1Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ProfileentryWidget.routeName,
          path: ProfileentryWidget.routePath,
          builder: (context, params) => ProfileentryWidget(),
        ),
        FFRoute(
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: Color(0xFF342F60),
                  child: Center(
                    child: Image.asset(
                      'assets/images/2bbe7b2223d14e5ec18b4a5b448028d8.gif',
                      width: 400.0,
                      height: 400.0,
                      fit: BoxFit.cover,
                    ),
