  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<OrdersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: FlutterFlowTheme.of(context).linen,
            body: Center(
              child: SizedBox(
                width: 50.0,
                height: 50.0,
        ...
        List<OrdersRecord> billingOrdersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final billingOrdersRecord = billingOrdersRecordList.isNotEmpty
            ? billingOrdersRecordList.first
            : null;
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          formatNumber(
                                            billingOrdersRecord!.totalPrice,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    final items = billingOrdersRecord?.foodItems
                                            ?.toList() ??
                                        [];
